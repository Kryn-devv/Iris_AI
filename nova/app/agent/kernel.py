"""AgentKernel orchestrating the multi-step lifecycle of NOVA."""
...
from nova.app.core.security import PermissionManager, PermissionLevel, PermissionDecision, default_permission_manager
from nova.app.core.logging import get_logger, correlation_id_ctx, task_id_ctx
...
from nova.app.agent.router import IntentRouter
from nova.app.agent.planner import Planner
from nova.app.agent.executor import ExecutionEngine
from nova.app.agent.task_manager import TaskManager
from nova.app.agent.context import ContextAssembler
from nova.app.agent.events import EventDispatcher, AgentEvent, AgentEventType, default_event_dispatcher
from nova.app.schemas.tasks import TaskStatus
from nova.app.schemas.messages import ChatResponse, ToolExecutionSummary

logger = get_logger("agent.kernel")


from nova.app.memory.service import MemoryService
from nova.app.language.service import default_language_service, LanguageService
