// NOVA Developer Chat Interface JavaScript Logic
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        try {
            ...
            typingElem.remove();
            showError('Network error. Failed to reach NOVA server.');
        } finally {
            setSendingState(false);
        }
    }
    ...
    function appendMessage(sender, text, meta = null) {
        ...
        const senderName = sender === 'user' ? 'You' : 'NOVA';
